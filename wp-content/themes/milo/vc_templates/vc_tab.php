...
$css_class = apply_filters( VC_SHORTCODE_CUSTOM_CSS_FILTER_TAG, 'tab-pane fade', $this->settings['base'], $atts );
$output .= "\n\t\t\t" . '<div class="' .  $css_class . '" id="tab-' . ( empty( $tab_id ) ? sanitize_title( $title ) : $tab_id ) . '">';
