...
add_action( 'tgmpa_register', 'milo_theme_register_required_plugins' );
/**
 ...
 */
function milo_theme_register_required_plugins() {
    ...
    $plugins = array(
        ...
        array(
            'name' => 'Milo Theme Core Plugin',
            'slug' => 'milo-core',
            'source' => dirname(__FILE__).'/zips/milo-core.zip',
            'required' => true,
        ),
        array(
