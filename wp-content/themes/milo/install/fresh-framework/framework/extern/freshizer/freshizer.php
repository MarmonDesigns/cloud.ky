...
// Optimal is approx 400 - 500 hits
    ...
    class fImg
    {
        ...
        public static function resize($url, $width, $height = false, $crop = false, $returnImgSize = false, $resizeMultiThread = false)
        {
            $width = (int)$width;
            $height = (int)$height;

            return self::getInstance()->_resize($url, $width, $height, $crop, $returnImgSize, $resizeMultiThread);
        }
        ...
        public function _resize($url, $width, $height = false, $crop = false, $returnImgSize = false)
        {
            if (empty($url)) return null;
