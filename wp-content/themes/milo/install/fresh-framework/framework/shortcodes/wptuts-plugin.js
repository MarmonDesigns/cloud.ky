(function() {
    tinymce.create('tinymce.plugins.Wptuts', {
        ...
        init : function(ed, url) {
        	...
        	ed.on( 'BeforeSetContent', function( e ) {
        		e.content = e.content.replace('kokotik', '<div style="background-color:red">kokotik</div>');
        		/*
        		if ( e.content ) {
        	...
        	ed.on( 'PostProcess', function( e ) {
        		e.content = e.content.replace('<div style="background-color:red">kokotik</div>', 'kokotik');
        		/*
        		if ( e.get ) {
    ...
    //tinymce.PluginManager.add( 'sds', tinymce.plugins.Wptuts );
})();